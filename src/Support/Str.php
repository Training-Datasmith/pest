...
final class Str
{
     ...
     */
    public static function starts_with(string $target, string $search): bool
    {
     ...
     */
    public static function ends_with(string $target, string $search): bool
    {
     ...
     */
    public static function describe(array $describe_descriptions, string $test_description): string
    {
        $description_components = [...$describe_descriptions, $test_description];
        return sprintf(str_repeat('`%s` → ', count($describe_descriptions)) . '%s', ...$description_components);
    }
    /**
